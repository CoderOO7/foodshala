...
$route['menu/add-to-cart'] = 'menu_items/add_to_cart';
$route['menu/delete/(:any)'] = 'menu_items/delete_item/$1';
$route['menu/edit/(:any)'] = 'menu_items/edit_item/$1';
$route['menu/add'] = 'menu_items/add_item';
$route['menu/view'] = 'menu_items/index';
